  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-md mx-4">
        {/* Header */}
        <div className="flex items-center justify-between px-5 pt-4 pb-3 border-b border-[#DFE1E6]">
        ...
        {isLoading ? (
          ...
          <div className="px-5 py-4 space-y-3.5">
            ...
            <div className="relative">
              <label className="block text-[10px] font-semibold text-[#5E6C84] uppercase tracking-wide mb-1">Status</label>
              <button
                type="button"
              ...
              >
                <span className={cn('text-[10px] px-1.5 py-0.5 rounded font-medium', STATUS_CATEGORY_COLORS[issue.fields.status.statusCategory?.key] ?? '')}>
                  {selectedStatus}
                </span>
            ...
            {/* Summary */}
            <div>
              <label className="block text-[10px] font-semibold text-[#5E6C84] uppercase tracking-wide mb-1">Summary</label>
              <textarea
                value={summary}
            ...
            <div className="flex items-center justify-between pt-2 border-t border-[#DFE1E6]">
              <span className="text-[10px] text-[#8993A4]">Changes saved as draft</span>
